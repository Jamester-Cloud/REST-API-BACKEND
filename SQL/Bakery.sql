...
-- -----------------------------------------------------
-- Table `enterprise`.`feedback`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enterprise`.`feedback` (
  `idfeedback` INT(11) NOT NULL AUTO_INCREMENT,
  `idCliente` INT(11) NOT NULL,
  `feedback` VARCHAR(1000) NULL DEFAULT NULL,
  PRIMARY KEY (`idfeedback`),
  INDEX `fk_feedback_cliente1_idx` (`idCliente` ASC),
...
CREATE TABLE IF NOT EXISTS `enterprise`.`ticket_soporte` (
  ...
  `causaTicketSoporte` VARCHAR(1000) CHARACTER SET 'big5' NULL DEFAULT NULL,
  `estatusTicket` CHAR(1) NULL DEFAULT '1',
  PRIMARY KEY (`idticketSoporte`),
  INDEX `fk_ticket_soporte_factura` (`idFactura` ASC),
  CONSTRAINT `fk_ticket_soporte_factura`
    FOREIGN KEY (`idFactura`)
    REFERENCES `enterprise`.`factura` (`idFactura`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 6
